...
import { createSubject, deleteSubject, getSubjects, updateSubject } from '../../services/supabaseApi';
...
const ManageSubjects: React.FC = () => {
    ...
    const handleUpdateSubject = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.error(error.message || 'Failed to update subject. Please try again.');
        } finally {
            setIsSubjectSubmitting(false);
        }
    };
                ...
                <div className="p-4 sm:p-6 space-y-6">
                    <div>
                        ...
                        <div className="space-y-2 max-h-64 overflow-y-auto">
                            {subjects.length === 0 ? (
                                <div className="text-center py-6 text-sm rounded-xl" style={{ color: 'var(--text-muted)', background: 'var(--glass)', border: '1px solid var(--glass-border)' }}>
                                    ...
                                    >
                                        ...
                                        <div className="flex items-center gap-1">
                                            <button
                                                ...
                                                className="p-3 rounded-xl transition-all hover:bg-blue-500/20 hover:text-blue-400 min-w-[44px] min-h-[44px] flex items-center justify-center"
                    ...
                    <div style={{ borderTop: '1px solid var(--glass-border)' }} className="pt-4 sm:pt-6">
                        <h3 className="text-sm font-medium mb-3" style={{ color: 'var(--text-primary)' }}>
                        ...
                        <form onSubmit={editingSubject ? handleUpdateSubject : handleCreateSubject} className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    disabled={isSubjectSubmitting || !!editingSubject}
                                />
                                ...
                                <div className="flex items-center gap-2 sm:gap-3">
                                    {COLORS.map((color) => (
                                        <button
                                            ...
                                            className={`w-9 h-9 sm:w-10 sm:h-10 rounded-full transition-all flex-shrink-0 ${subjectFormData.color === color ? 'ring-2 ring-white scale-110' : 'hover:scale-105'}`}
                            ...
                            <div className="flex gap-2">
                                ...
                                {editingSubject && (
                                    <button
                                        ...
                                        className="px-4 py-2.5 rounded-xl font-medium text-sm transition-all hover:scale-[1.02]"
